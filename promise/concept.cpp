...
void doSomething(std::promise<std::string>& p)
{
	...
	If you want the shared state to become ready when the thread really ends — to ensure the
		cleanup of thread local objectsand other stuff before the result gets processed — you have to call
		set_value_at_thread_exit() or set_exception_at_thread_exit() instead:
